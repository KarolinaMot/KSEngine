...
{
    assert(true && "Error occurred in DXRHealpers");
}
...
inline IDxcBlob* CompileShaderLibrary(LPCWSTR fileName)
{
    ...
    std::ifstream shaderFile(fileName);
        ...
        ThrowIfFailed(
            pCompiler->Compile(pTextBlob, fileName, L"", L"lib_6_3", nullptr, 0, nullptr, 0, dxcIncludeHandler, &pResult));
        ...
        if (FAILED(resultCode))
        {
            ...
            int r = MessageBoxA(nullptr, errorMsg.c_str(), "Error!", MB_ICONERROR | MB_RETRYCANCEL);
