    ...
    static Formats DXGIFormatsToKS(DXGI_FORMAT format)
    {
        switch (format)
        {
            case DXGI_FORMAT_R8G8B8A8_UNORM:
                return Formats::R8G8B8A8_UNORM;

            case DXGI_FORMAT_R8G8B8A8_UINT:
                return Formats::R8G8B8A8_UINT;

            case DXGI_FORMAT_R8G8B8A8_UNORM_SRGB:
                return Formats::R8G8B8A8_UNORM_SRGB;

            case DXGI_FORMAT_R16G16B16A16_FLOAT:
                return Formats::R16G16B16A16_FLOAT;

            case DXGI_FORMAT_R32G32B32A32_FLOAT:
                return Formats::R32G32B32A32_FLOAT;

            case DXGI_FORMAT_R32G32B32A32_UINT:
                return Formats::R32G32B32A32_UINT;

            case DXGI_FORMAT_R16_FLOAT:
                return Formats::R16_FLOAT;

            case DXGI_FORMAT_R32_FLOAT:
                return Formats::R32_FLOAT;

            case DXGI_FORMAT_D32_FLOAT:
                return Formats::D32_FLOAT;

            case DXGI_FORMAT_R32_TYPELESS:
                return Formats::R32_TYPELESS;
