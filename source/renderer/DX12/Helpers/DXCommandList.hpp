...
public:
    ...
    void BindVertexData(DXResource& buffer, size_t bufferStride, int inputSlot, int elementOffset);
    void BindIndexData(DXResource& buffer, size_t bufferStride, int elementOffset);
