...
public:
    ...
    void BindHeapResource(DXResource& resource, const DXHeapHandle& handle, int rootSlot);
    ...
    void TransitionResource(ID3D12Resource& resource, D3D12_RESOURCE_STATES srcState, D3D12_RESOURCE_STATES dstState);
