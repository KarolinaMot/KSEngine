...
public:
    ...
    void BindVertexData(DXResource& buffer, uint32_t bufferStride, uint32_t inputSlot, uint32_t elementOffset,
                        uint32_t elementCount);
    void BindIndexData(DXResource& buffer, uint32_t bufferStride, uint32_t elementOffset, uint32_t elementCount);
