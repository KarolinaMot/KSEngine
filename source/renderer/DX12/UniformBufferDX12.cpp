...
void KS::UniformBuffer::Bind(uint32_t frameIndex, void*, DXCommandList& commandList, const ShaderInputDesc& desc,
                             uint32_t offsetIndex)
{
    if (m_double_buffer)
        commandList.BindBuffer(*m_impl->mBuffers[frameIndex], desc.rootIndex, m_buffer_stride, offsetIndex);
    else
