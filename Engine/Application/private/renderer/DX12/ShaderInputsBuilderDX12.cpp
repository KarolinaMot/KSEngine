...
class ShaderInputsBuilder::Impl
{
public:
...
ShaderInputsBuilder::ShaderInputsBuilder()
{
...
ShaderInputsBuilder& ShaderInputsBuilder::AddUniform(ShaderInputVisibility visibility, std::string name)
{
    ShaderInput input;
...
ShaderInputsBuilder& ShaderInputsBuilder::AddStorageBuffer(ShaderInputVisibility visibility, int numberOfElements, std::string name, ShaderInputMod modifiable)
{
    ShaderInput input;
...
ShaderInputsBuilder& ShaderInputsBuilder::AddTexture(ShaderInputVisibility visibility, std::string name, ShaderInputMod modifiable)
{
    ShaderInput input;
    input.modifications = modifiable;
    input.rootIndex = m_input_counter;
...
ShaderInputsBuilder& ShaderInputsBuilder::AddStaticSampler(ShaderInputVisibility visibility, SamplerDesc samplerDesc)
{
...
std::shared_ptr<ShaderInputs> ShaderInputsBuilder::Build(const Device& device, std::string name)
{
...
D3D12_SHADER_VISIBILITY ShaderInputsBuilder::Impl::GetVisibility(ShaderInputVisibility visibility)
{
