...
// DXStructuredBuffer::DXStructuredBuffer(ID3D12Device* device, size_t dataSize, int numOfElements, const char* bufferDebugName, int frameNumber, D3D12_RESOURCE_FLAGS flags)
// {
...
// {
//     return m_resource->GetResource()->GetGPUVirtualAddress();
// }

// void DXStructuredBuffer::Resize(ID3D12Device* device, int numberOfElements)
// {
...
// void DXStructuredBuffer::AllocateAsUAV(ID3D12Device* device, DXDescriptorHeap* descriptorHeap)
// {
...
//     m_UAV_handle = descriptorHeap->Allocate(device, m_resource->GetResource(), ViewParams::UAV { uavDesc }).value();
// }

// void DXStructuredBuffer::AllocateAsSRV(ID3D12Device* device, DXDescriptorHeap* descriptorHeap)
// {
...
//     m_SRV_handle = descriptorHeap->Allocate(device, m_resource->GetResource(), ViewParams::SRV { srvDesc }).value();
// }

// void DXStructuredBuffer::Bind(DXCommandList* commandList, int rootSlot, bool readOnly, DXDescriptorHeap* descriptorHeap)
// {
//     if (readOnly)
//     {
